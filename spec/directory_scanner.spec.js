    ...
    'the Directory Scanner,': {
      ...
      'when run on a directory with 10 files with a limit of 3': {
        ...
        "and when run using next() details": {
          topic: function(scanResult, scanner) {
            scanner.scan(scanner.directory, scanResult.next(), this.callback);
          },
          ...
          "then the prev() details": {
            topic: function(scanResult, placeholder, scanner) {
              scanner.scan(scanner.directory, scanResult.prev(), this.callback);
            },
        ...
        "and when run just 'before' from next() details": {
          topic: function(scanResult, scanner) {
            ...
            scanner.scan(scanner.directory, options, this.callback);
          },
          ...
          "a next() function should not be provided": 
            function(err, scanResult) {
              scanResult.should.not.have.property('next');
            },
          "a prev() function should be provided": function(err, scanResult) {
